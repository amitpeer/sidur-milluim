...
type SortField = keyof Pick<
  SoldierStats,
  "fullName" | "daysInArmy" | "daysAtHome" | "constraintDaysOff" | "totalDaysAtHome" | "kavDays" | "kavPercentage" | "onDutyPercentage"
>;
...
const COLUMNS: readonly {
  ...
  { field: "onDutyPercentage", label: "% כולל", colorClass: "text-purple-600 dark:text-purple-300", bgClass: "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-200" },
  { field: "kavDays", label: "ימי קו", colorClass: "text-orange-700 dark:text-orange-300", bgClass: "bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-200" },
  { field: "kavPercentage", label: "% קו", colorClass: "text-orange-600 dark:text-orange-300", bgClass: "bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-200" },
];
              ...
              >
                ...
                {COLUMNS.map((col) => (
                  <td key={col.field} className={`px-2 py-2 text-center ${col.colorClass}`}>
                    {col.field === "onDutyPercentage" || col.field === "kavPercentage" ? `${s[col.field]}%` : s[col.field]}
                  </td>
                ))}
              </tr>
            ))}
